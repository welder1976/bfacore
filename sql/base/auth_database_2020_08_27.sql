...
MySQL - 5.6.47 : Database - bfa_auth
*********************************************************************
*/
...
(1,'1#1','˚wÉà™óód%’Ï∏€\'†@_O#êVà˜9…˛åK','ˇ\Zö7éÂQ\\Vì0·v_¨Îëòa›V~‚Ui',NULL,NULL,'','dummy value, use `verifier` instead','dummy value, use `salt` instead','GM@GM','2020-08-18 20:09:45','127.0.0.1',0,0,'00','0000-00-00 00:00:00',0,8,0,0,'',0,0,1,1,'','',0,0,0,'GM@GM','127.0.0.1');
...
(1,'BfaCore 8.3.7','127.0.0.1','127.0.0.1','255.255.255.0',8085,0,2,1,0,0,35435,1,1);
