...
class spell_rog_backstab : public SpellScript
{
    ...
    void Register() override
    {
        OnEffectHitTarget += SpellEffectFn(spell_rog_backstab::HandleDamage, EFFECT_0, SPELL_EFFECT_DUMMY);
    }
};
