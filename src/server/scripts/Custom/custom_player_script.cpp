...
/* Welcome message */
/*class BfaCoreWelcome : public PlayerScript
{
public:
    BfaCoreWelcome() : PlayerScript("BfaCoreWelcome") { }

    void OnLogin(Player* player, bool) override
    {
        ChatHandler(player->GetSession()).SendSysMessage("|cffFF0000BfaCore https://www.bfacore.com/discord BfaCore@yahoo.com|r");
    }
};*/
...
void AddSC_custom_player_script()
{
    ...
    //RegisterPlayerScript(BfaCoreWelcome);
}
