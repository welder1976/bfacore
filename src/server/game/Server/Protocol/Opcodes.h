...
enum OpcodeClient : uint16
{
    ...
    CMSG_BATTLE_PAY_PURCHASE_PRODUCT                  = 0xBADD, // OUTDATED
    CMSG_GUILD_BANK_MOVE_ITEMS_PLAYER_BANK            = 0xBADD, // OUTDATED
    CMSG_GUILD_BANK_MOVE_ITEMS_BANK_PLAYER            = 0xBADD, // OUTDATED
    CMSG_GUILD_BANK_MOVE_ITEMS_BANK_BANK              = 0xBADD, // OUTDATED
    CMSG_GUILD_BANK_MOVE_ITEMS_PLAYER_BANK_COUNT      = 0xBADD, // OUTDATED
    CMSG_GUILD_BANK_MOVE_ITEMS_BANK_PLAYER_COUNT      = 0xBADD, // OUTDATED
    CMSG_GUILD_BANK_MOVE_ITEMS_BANK_BANK_COUNT        = 0xBADD, // OUTDATED
    CMSG_GUILD_BANK_MOVE_ITEMS_BANK_PLAYER_AUTO       = 0xBADD, // OUTDATED
    CMSG_GUILD_BANK_MERGE_ITEMS_PLAYER_BANK           = 0xBADD, // OUTDATED
    CMSG_GUILD_BANK_MERGE_ITEMS_BANK_PLAYER           = 0xBADD, // OUTDATED
    CMSG_GUILD_BANK_MERGE_ITEMS_BANK_BANK             = 0xBADD, // OUTDATED
    CMSG_GUILD_BANK_SWAP_ITEMS_BANK_PLAYER            = 0xBADD, // OUTDATED
    CMSG_GUILD_BANK_SWAP_ITEMS_BANK_BANK              = 0xBADD, // OUTDATED
};
...
enum OpcodeServer : uint16
{
    ...
    SMSG_ARENA_MATCH_END                              = 0xBADD, // OUTDATED
    SMSG_ARENA_MATCH_START                            = 0xBADD, // OUTDATED
};
