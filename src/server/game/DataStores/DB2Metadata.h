...
// needs layoutHash for 8.3.0 (0x43F2E414 is wrong)
struct CharShipmentMeta
{
    static DB2Meta const* Instance()
    {
        static DB2MetaField const fields[10] =
        {
            ...
            { FT_INT,   1, false },     //ID
            { FT_SHORT, 1, false },     //ContainerID
            { FT_INT,   1, false },     //DummyItemID
            { FT_INT,   1, false },     //TreasureID
            { FT_INT,   1, false },     //SpellID
            { FT_INT,   1, false },     //OnCompleteSpellID
            { FT_INT,   1, false },     //Duration
            { FT_BYTE,  1, false },     //MaxShipments
            { FT_SHORT, 1, false },     //GarrFollowerID
            { FT_BYTE,  1, false },     //Flags
        };
        ...
        static DB2Meta instance(           972425,                0,                10,                    10,        0x43F2E414,                     fields,                      0);
        return &instance;
    }
};

// needs layoutHash for 8.3.0 (0x9692590F is wrong)
struct CharShipmentContainerMeta
{
    static DB2Meta const* Instance()
    {
        ...
        static DB2Meta instance(972405, 0, 17, 17, 0x9692590F, fields, 0);
        return &instance;
    }
};
