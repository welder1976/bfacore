...
#define LOAD_DB2(store) LoadDB2(availableDb2Locales, bad_db2_files, _stores, &store, db2Path, defaultLocale, GetCppRecordSize(store))
  ...
  //  LOAD_DB2(sAlliedRaceRacialAbilityStore);
    ...
    //LOAD_DB2(sCharShipmentStore);             // needs layoutHash for 8.3.0 (0x43F2E414 is wrong) DB2Metada.h
    //LOAD_DB2(sCharShipmentContainerStore);    // needs layoutHash for 8.3.0 (0x9692590F is wrong) DB2Metada.h
